...
public class BlurKit {
    ...
    private static com.example.rachit.aemjdemo.Utility.BlurKit instance;
    ...
    public static void init(Context context) {
        ...
        instance = new com.example.rachit.aemjdemo.Utility.BlurKit();
    ...
    public static com.example.rachit.aemjdemo.Utility.BlurKit getInstance() {
        if (instance == null) {
