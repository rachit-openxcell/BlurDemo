...
public class BottomSheetBehaviorGoogleMapsLike<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public abstract static class BottomSheetCallback {
         ...
         */
        public abstract void onStateChanged(@NonNull View bottomSheet, @com.mahc.custombottomsheetbehavior.BottomSheetBehaviorGoogleMapsLike.State int newState);
    ...
    @com.mahc.custombottomsheetbehavior.BottomSheetBehaviorGoogleMapsLike.State
    ...
    private Vector<com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike.BottomSheetCallback> mCallback;
    ...
    public Parcelable onSaveInstanceState( CoordinatorLayout parent, V child ) {
        return new com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike.SavedState(super.onSaveInstanceState(parent, child), mState);
    }

    @Override
    public void onRestoreInstanceState( CoordinatorLayout parent, V child, Parcelable state ) {
        com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike.SavedState ss = (com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike.SavedState) state;
    ...
    private com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike.ScrollVelocityTracker mScrollVelocityTracker = new com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike.ScrollVelocityTracker();
    ...
    public void onStopNestedScroll( CoordinatorLayout coordinatorLayout, V child, View target ) {
        ...
        if ( mViewDragHelper.smoothSlideViewTo( child, child.getLeft(), top ) ) {
            ...
            ViewCompat.postOnAnimation( child, new com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike.SettleRunnable( child, targetState ) );
        } else {
     ...
     */
    public void addBottomSheetCallback(com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike.BottomSheetCallback callback) {
        if (mCallback == null)
     ...
     */
    public final void setState( @com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike.State int state ) {
        if ( state == mState ) {
            return;
        }
        if ( mViewRef == null ) {
        ...
        setStateInternal(STATE_SETTLING);
        if (mViewDragHelper.smoothSlideViewTo(child, child.getLeft(), top)) {
            ViewCompat.postOnAnimation(child, new com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike.SettleRunnable(child, state));
        }
    }
     ...
     */
    @com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike.State
    public final int getState() {
        return mState;
    }

    private void setStateInternal(@com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike.State int state) {
        if (mState == state) {
            return;
        }
        mState = state;
...
//            mCallback.onStateChanged(bottomSheet, state);
    ...
    private void notifyStateChangedToListeners(@NonNull View bottomSheet, @com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike.State int newState) {
        for (com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike.BottomSheetCallback bottomSheetCallback:mCallback) {
    ...
    private final ViewDragHelper.Callback mDragCallback = new ViewDragHelper.Callback() {
        ...
        public void onViewReleased( View releasedChild, float xvel, float yvel ) {
            int top;
            @com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike.State int targetState;
            if ( yvel < 0 ) { // Moving up
                top = mMinOffset;
                targetState = STATE_EXPANDED;
            }
            ...
            if ( mViewDragHelper.settleCapturedViewAt(releasedChild.getLeft(), top) ) {
                ...
                ViewCompat.postOnAnimation(releasedChild,
                        new com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike.SettleRunnable(releasedChild, targetState));
            } else {
                setStateInternal(targetState);
            }
        }
    ...
    private class SettleRunnable implements Runnable {
        ...
        SettleRunnable( View view, @com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike.State int targetState ) {
            mView = view;
    ...
    protected static class SavedState extends View.BaseSavedState {
        ...
        public SavedState(Parcelable superState, @com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike.State int state) {
            super(superState);
            this.state = state;
        }
        ...
        public static final Parcelable.Creator<com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike.SavedState> CREATOR =
                new Parcelable.Creator<com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike.SavedState>() {
                    @Override
                    public com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike.SavedState createFromParcel(Parcel source) {
                        return new com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike.SavedState(source);
                    }

                    @Override
                    public com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike.SavedState[] newArray(int size) {
                        return new com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike.SavedState[size];
                    }
                };
    }

    /**
     * A utility function to get the {@link com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike}.
     * @param <V> Instance of behavior
     * @return The {@link com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike<V> from(V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike)) {
            throw new IllegalArgumentException(
                    "The view is not associated with BottomSheetBehaviorGoogleMapsLike");
        }
        return (com.example.rachit.aemjdemo.Utility.BottomSheetBehaviorGoogleMapsLike<V>) behavior;
    }
